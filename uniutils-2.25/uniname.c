/* Time-stamp: <2007-06-30 00:07:33 poser>
 *
 * Prints the names of the characters in a Unicode file.
 * 
 * 
 * Copyright (C) 2003-2007 William J. Poser (billposer@alum.mit.edu)
 *
...
ShowVersion(void){
  ...
  fprintf(stderr,"%s\n",compdate);
  fprintf(stderr,"Copyright (C) 2003-2007 William J. Poser\n");
...
ShowUsage(void){
  ...
  fprintf(stderr,"       -l Print line number.\n");
  ...
  fprintf(stderr,"       -r Print Unicode range.\n");
